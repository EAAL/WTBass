...
//This function get all user's photos and save it to database and shuffle them, 
...
// This function generate some question about the people who were tagged.
				...
				for (var k = 0; k < qCount; k++) {
					...
					for (var j = data[i].tags.length - 1; j >= 0; j--) {
						if(data[i].tags[j].id != req.session.userID){
							var r = Math.random();
							// This is a random selection of people who goes to the event or not
							if(r < 1.3/3.0)
							{
